    ...
    <div className="flex items-center justify-center">
      {href ? (
        <Link href={href}>
          ...
          >
            <div className="border border-[#3B3A3A] bg-[#a217ff]  h-[43px] rounded-full flex items-center justify-center text-white">
        ...
        >
          <div className="border border-[#3B3A3A] bg-[#a32cce]  h-[43px] rounded-full flex items-center justify-center text-white">
